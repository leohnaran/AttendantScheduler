...
interface MergeModalProps {
  ...
  personnel: Person[];
  handleMergeAction: (targetId: number) => Promise<void> | void;
}

export default function MergeModal({ mergingId, setMergingId, personnel, handleMergeAction }: MergeModalProps) {
